...
<node ID="ID_606024407" 
	TEXT="position">
<node FOLDED="true" ID="ID_566913331" POSITION="right" 
	TEXT="CEO(Chief Executive Officer)">
<node ID="ID_516420306" 
	TEXT="首席执行官"/>
<node ID="ID_1180582603" 
	TEXT="是一个在一个企业中负责日常经营管理的最高级管理人员"/>
<node ID="ID_1616099768" 
	TEXT="行政总裁(香港/东南亚)"/>
</node>
</node>
</map>
